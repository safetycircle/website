...
// http://bit.ly/magnific-popup#build=inline+image+iframe
(function(a) {
    var b = "Close",
        c = "BeforeClose",
        d = "AfterClose",
    ...
    var M = "iframe",
        ...
        O = function(a) {
            if (n.currTemplate[M]) {
                var b = n.currTemplate[M].find("iframe");
                b.length && (a || (b[0].src = N), n.isIE8 && b.css("display", a ? "block" : "none"))
            }
        };
    a.magnificPopup.registerModule(M, {
        ...
        proto: {
            initIframe: function() {
                n.types.push(M), x("BeforeChange", function(a, b, c) {
                    b !== c && (b === M ? O() : c === M && O(!0))
                }), x(b + "." + M, function() {
                    O()
                })
